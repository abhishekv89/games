...
questionInteractive.prototype.loadQuestions = function()
{
    ...
    html += '<input id="answer1" autofocus="autofocus"></input>';
    ...
    if (correctQues_3_flagVisible == 1)
    {
        ...
        if (notInLowestFormFlag == 1 && attemp_Ques3 == 1 && correct_firstAttempt == 1)
        {
            ...
            $('#FractionDivided').append('<div class="equal_Questions">=</div><div id="inputField"><input id="Input_num3"></input><input id="Input_denom3"></input></div>');
    ...
    if (correctQues_4_flag == 1)    //------------------ QUESTION 4 VISIBILITY SETTINGS ------------- //
    {
        ...
        if (notInLowestFormFlagQ4 == 1 && attemp_Ques4 == 1 && correct_firstAttemptQ4 == 1)
        {
            ...
            $('#FractionDivided4').append('<div class="equal_Questions">=</div><div id="inputField"><input id="Input_num4"></input><input id="Input_denom4"></input></div>');
            $("#Input_num4").focus();
    ...
    if (Question6_Visible == 1)
    {
        ...
        if (called1 == 1)
        {
            ...
            $("#sixthQuestion").append('<div id="sixthQuestion_1">' + replaceDynamicText(interactiveObj.sixth, interactiveObj.numberLanguage, "interactiveObj") + '&nbsp;=</div><input id="answer6"></input><div id="fractionAnswer6"></div>');
        ...
        else if (called3 == 1)
        {
            ...
            $("#sixthQuestion").append('<div id="sixthQuestion_6">' + replaceDynamicText(interactiveObj.sixth, interactiveObj.numberLanguage, "interactiveObj") + '&nbsp;=</div><input id="answer6"></input><div id="fractionAnswer6"></div><div id="FractionDivided6"></div>');
            ...
            if (notInLowestFormQ6 == 1 && attemp_Ques6 == 1 && correct_firstAttemptQ6 == 1)
            {
                ...
                $("#FractionDivided6").css('visibility', 'visible');
                $("#FractionDivided6").append('<div class="equal_Questions">=</div><div id="inputField6"><input id="Input_num6"></input><input id="Input_denom6"></input></div>');
    ...
    {//question 7 starts
        ...
        if (called21 == 1)
        {
            ...
            $("#seventhQuestion").append('<div id="seventhQuestion_7">' + replaceDynamicText(interactiveObj.seventh, interactiveObj.numberLanguage, "interactiveObj") + '&nbsp;=</div><input id="answer7"></input><div id="fractionAnswer7"></div>');
        ...
        {//----if for called 3 starts
            ...
            if (notInLowestFormQ7 == 1 && attemp_Ques7 == 1 && correct_firstAttemptQ7 == 1)
            {
                ...
                $("#FractionDivided7").css('visibility', 'visible');
                $("#FractionDivided7").append('<div class="equal_Questions" style="top: 12px;left: 10px;">&nbsp;=&nbsp;</div><div id="inputField7"><input id="Input_num7"></input><input id="Input_denom7"></input></div>');
        ...
        {//----if for called 3 starts
            ...
            //$("#seventhQuestion").append('<div id="seventhQuestion_7">'+replaceDynamicText(interactiveObj.seventh,interactiveObj.numberLanguage,"interactiveObj")+'&nbsp;=</div><input id="answer7"></input><div id="fractionAnswer7"></div><div id="FractionDivided7"></div><button id="button_7" type="button" name="" value="" class="css3button" onclick=interactiveObj.checkAnswer("seven");>'+promptArr['txt_17']+'</button>');
            $("#seventhQuestion").append('<div id="seventhQuestion_7">' + replaceDynamicText(interactiveObj.seventh, interactiveObj.numberLanguage, "interactiveObj") + '&nbsp;=</div><input id="answer7"></input><div id="fractionAnswer7"></div><div id="FractionDivided7"></div>');
            ...
            if (notInLowestFormQ7 == 1 && attemp_Ques7 == 1 && correct_firstAttemptQ7 == 1)
            {
                ...
                //$("#answer7").css('left','177px');
                $("#FractionDivided7").css('visibility', 'visible');
                $("#FractionDivided7").append('<div class="equal_Questions" style="top: 12px;left: 27px;">=</div><div id="inputField7"><input id="Input_num7"></input><input id="Input_denom7"></input></div>');
